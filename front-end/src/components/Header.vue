  ...
  <div class="headerContainer">
    ...
    <div class="right">
      ...
      <div v-if="nickName" style="display: flex; justify-content: center; align-items: center;">
        <Avatar avatarSize=30 marginTop=90 />
             <el-dropdown>
          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <el-dropdown-item @click="yourProfile">Your Profile</el-dropdown-item>
              <el-dropdown-item @click="showHistory">History</el-dropdown-item>
       ...
       <div v-else class="containerButton">
          <el-button size="small" style="background: #212529; color: #aea7a2" @click="toLogin">Login</el-button>
...
const HighlightHandler = (index) => {
  ...
  router.push({name: "HeadlineNews", query:{type: findAllTypeList.value[index].tid}})
